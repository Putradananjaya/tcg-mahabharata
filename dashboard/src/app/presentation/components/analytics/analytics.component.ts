  ...
  template: `
    <div style="display: flex; flex-direction: column; gap: 20px;">
      ...
      <div style="display: flex; justify-content: space-between; align-items: center; background: #ffffff; padding: 16px 20px; border-radius: 12px; border: 1px solid var(--border-color, #e0e0e0); box-shadow: 0 2px 6px rgba(0,0,0,0.03);">
        <div>
          <h2 style="margin: 0; font-size: 18px; font-weight: 700; color: #1a1a1a;">Visual Analytics (Interactive Demo — Illustrative Data)</h2>
          <p style="margin: 4px 0 0 0; font-size: 13px; color: #b00020; font-weight: 600;">These charts use hand-authored placeholder data for UI demonstration, not output from the Python simulator. They are not citable paper results — see CLAIMS_LEDGER.md and figures/ for the real, verified findings.</p>
        </div>
      ...
      <div class="analytics-grid" [style.grid-template-columns]="columns === 1 ? '1fr' : 'repeat(auto-fit, minmax(300px, 1fr))'" style="display: grid; gap: 32px;">
        ...
        <div class="chart-card md-card" style="display: flex; flex-direction: column; gap: 12px; min-height: 500px; padding: 24px; background: #fff; border-radius: 12px; border: 1px solid var(--border-color, #e0e0e0);">
          <h3 style="margin: 0; font-size: 18px; font-weight: 700; color: #111;">Bifurcation Curve: Sensitivity Analysis (Illustrative)</h3>
          <p class="chart-desc" style="font-size: 13.5px; color: #555; margin: 0; line-height: 1.4;">Placeholder curve generated by a fixed linear formula, not measured win rates. Real Karna HP sweep: <code>results/exp09_karna_hp_ci.json</code> / <code>figures/exp09_karna_hp_ci.png</code> — which found the closest faction pair is Satwika/Tamasika, not Satwika/Rajasika.</p>
        ...
        <div class="chart-card md-card" style="display: flex; flex-direction: column; gap: 12px; min-height: 500px; padding: 24px; background: #fff; border-radius: 12px; border: 1px solid var(--border-color, #e0e0e0);">
          <h3 style="margin: 0; font-size: 18px; font-weight: 700; color: #111;">Time Complexity: GA Execution Time (Illustrative)</h3>
          <p class="chart-desc" style="font-size: 13.5px; color: #555; margin: 0; line-height: 1.4;">Placeholder values, not measured timing. The real complexity study (<code>results/exp08_dimension_scaling.json</code>) found this pipeline is explicitly NOT O(1) — it only looks flat up to d≈200 and rises past d≈5,000.</p>
          <div class="canvas-container" style="height: 420px; position: relative; width: 100%; background: #fafafa; border-radius: 8px; padding: 16px; border: 1px solid #e5e5e5; box-sizing: border-box;">
        ...
        <div class="chart-card md-card" style="display: flex; flex-direction: column; gap: 12px; min-height: 500px; padding: 24px; background: #fff; border-radius: 12px; border: 1px solid var(--border-color, #e0e0e0);">
          <h3 style="margin: 0; font-size: 18px; font-weight: 700; color: #111;">Power Spike Trend Curve (Illustrative)</h3>
          <p class="chart-desc" style="font-size: 13.5px; color: #555; margin: 0; line-height: 1.4;">Hand-authored placeholder curve, not measured per-turn power data — no script in this repo currently produces this metric from real match logs.</p>
          <div class="canvas-container" style="height: 420px; position: relative; width: 100%; background: #fafafa; border-radius: 8px; padding: 16px; border: 1px solid #e5e5e5; box-sizing: border-box;">
        ...
        <div class="chart-card md-card" style="display: flex; flex-direction: column; gap: 12px; min-height: 500px; padding: 24px; background: #fff; border-radius: 12px; border: 1px solid var(--border-color, #e0e0e0);">
          <h3 style="margin: 0; font-size: 18px; font-weight: 700; color: #111;">K-Means Emergent Playstyle Clusters (Illustrative)</h3>
          <p class="chart-desc" style="font-size: 13.5px; color: #555; margin: 0; line-height: 1.4;">Fixed placeholder scatter points, not output of a real K-means fit — no clustering script currently exists in this repo's experiments/.</p>
          <div class="canvas-container" style="height: 420px; position: relative; width: 100%; background: #fafafa; border-radius: 8px; padding: 16px; border: 1px solid #e5e5e5; box-sizing: border-box;">
